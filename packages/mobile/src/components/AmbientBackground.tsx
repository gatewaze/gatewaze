...
const FIELDS: FieldSpec[] = [
  ...
  { colorIndex: 0, size: 560, opacity: 0.72, left: -120, top: -60, durationMs: 6500, dx: 100, dy: 85, swellMs: 5200, swellTo: 1.15 },
  // Green, right edge at mid-height.
  { colorIndex: 1, size: 520, opacity: 0.62, left: FRAME_W - 320, top: FRAME_H * 0.30, durationMs: 8000, dx: -115, dy: -85, swellMs: 6100, swellTo: 0.88 },
  // Violet, lower-left.
  { colorIndex: 2, size: 540, opacity: 0.64, left: -140, top: FRAME_H * 0.52, durationMs: 9000, dx: 130, dy: -85, swellMs: 7300, swellTo: 1.18 },
  // Amber, upper-right. Weaker than the rest because warm colours advance.
  { colorIndex: 3, size: 460, opacity: 0.46, left: FRAME_W - 280, top: -80, durationMs: 10500, dx: -100, dy: 115, swellMs: 6700, swellTo: 1.12 },
  // Cyan, lower-centre.
  { colorIndex: 4, size: 500, opacity: 0.56, left: FRAME_W * 0.22, top: FRAME_H * 0.72, durationMs: 11500, dx: 85, dy: -100, swellMs: 8100, swellTo: 0.9 },
  // A second blue, centre-right, tying the field together.
  { colorIndex: 0, size: 480, opacity: 0.40, left: FRAME_W * 0.42, top: FRAME_H * 0.34, durationMs: 13500, dx: -70, dy: 70, swellMs: 9300, swellTo: 1.1 },
];
