      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              'group/sidebar-wrapper flex min-h-[100svh] w-full',
              className,
            )}
            ref={ref}
            {...props}
  ...
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width-mobile)] sidebar-glass p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'relative h-[100svh] w-[var(--sidebar-width)] bg-transparent transition-[width] duration-200 ease-linear',
        ...
        <div
          className={cn(
            'fixed inset-y-0 z-10 hidden h-[100svh] w-[var(--sidebar-width)] transition-[left,right,width] duration-200 ease-linear md:flex pt-4 pb-4 pl-4',
            side === 'left'
          ...
          {...props}
        >
          <GlowBorder className="h-full w-full" borderRadius="0.75rem" borderWidth={1} glowSize={300}>
            <div
              data-sidebar="sidebar"
              className={cn(
                'flex h-full w-full flex-col sidebar-glass rounded-xl overflow-hidden',
              )}
            >
              {children}
            </div>
