...
export default function TestFluidPage() {
  ...
  const [activeBrand, setActiveBrand] = useState<BrandKey>('demo')
      ...
      >
        ...
        <div style={{ marginBottom: '8px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              onClick={() => setActiveBrand('demo')}
              style={{
                padding: '8px 16px',
                borderRadius: '6px',
                border: activeBrand === 'demo' ? '2px solid white' : '2px solid transparent',
                background: '#ca2b7f',
                color: 'white',
                cursor: 'pointer',
                fontSize: '13px',
            ...
            <button
              onClick={() => setActiveBrand('acme')}
              style={{
                padding: '8px 16px',
                borderRadius: '6px',
                border: activeBrand === 'acme' ? '2px solid white' : '2px solid transparent',
                background: '#ee4443',
                color: 'white',
                cursor: 'pointer',
                fontSize: '13px',
