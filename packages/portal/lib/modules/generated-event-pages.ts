...
export const eventModulePages: EventModulePage[] = [
  { slug: 'open-rsvp', moduleId: 'event-invites', label: 'Open RSVP', icon: 'envelope', order: 91, requiresLocalStorage: 'open_rsvp_code', component: () => import('/premium-gatewaze-modules/modules/event-invites/portal/event-pages/open-rsvp') },
