  ...
  useEffect(() => {
    async function checkExistingSubmission() {
      ...
      try {
        ...
        // Get all talks submitted by this speaker for this event — plain
        // decomposed lookups (participation → bridge → talks). The previous
        // embed resolved events_talk_speakers → events_speakers, but the
        // bridge's speaker_id FK targets events_speaker_profiles, so
        // PostgREST rejected the query (PGRST200) and existing submissions
        // never surfaced.
