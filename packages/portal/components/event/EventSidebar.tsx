    ...
    <div className="lg:hidden pb-6" ref={menuRef}>
      ...
      <div className="flex items-center gap-3">
        ...
        {!isConfirmedSpeaker && isRegistered && (() => {
          ...
          if (slug) {
            const eventUrl = `https://home.example.com/public/events/${slug}`
            const joinUrl = `https://home.example.com/login?event=${slug}&returnTo=${encodeURIComponent(eventUrl)}&type=event`
            return (
              <PortalButton
                variant="primary"
                primaryColor={primaryColor}
