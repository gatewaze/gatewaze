...
const BRAND_CONFIG = {
  'example.com': {
    ...
    supabaseKey: Deno.env.get('DEMO_SERVICE_ROLE_KEY') || Deno.env.get('SUPABASE_SERVICE_ROLE_KEY'),
  },
  'tech.tickets': {
    supabaseUrl: 'https://data.tech.tickets',
    supabaseKey: Deno.env.get('ACME_SERVICE_ROLE_KEY') || Deno.env.get('SUPABASE_SERVICE_ROLE_KEY'),
  },
};
