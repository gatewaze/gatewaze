...
- Works with both tech.tickets and Demo brands (separate VAPID keys)
...
supabase secrets set VAPID_SUBJECT="mailto:support@example.com" --project-ref wdewqtcctpdqxypwnlhp
```
...
```json
{
  ...
  "notification": {
    ...
    "url": "/badge/event-123",
    "icon": "/img/favicon/acme/android-icon-192x192.png",
    "badge": "/img/favicon/acme/android-icon-96x96.png",
    "tag": "event-reminder",
...
Each brand (tech.tickets and Demo) has its own Supabase project with its own:
